...
\________|\__|  \__|\__|  \__| \______/ \______|   \__|         */
    ...
    return (
        <View style={styles.screen} {...(Platform.OS === 'web' ? { className: 'create-screen' } : {})}>
            ...
            {/* Text Fields */}
            <View style={styles.form} {...(Platform.OS === 'web' ? { className: 'create-form' } : {})}>
                
            {/* Start ng Email Address */}
                <View style={[styles.inputWrapper, styles.emailInputWrapper]} {...(Platform.OS === 'web' ? { className: 'input-wrapper email-input-wrapper' } : {})}>
            ...
            {/* Start ng Password */}
                <View style={styles.inputWrapper} {...(Platform.OS === 'web' ? { className: 'input-wrapper' } : {})}>
            ...
            {/* Start ng Checkbox */}
                <View style={styles.checkboxRow} {...(Platform.OS === 'web' ? { className: 'checkbox-row' } : {})}>
                    <TouchableOpacity style={styles.checkbox} onPress={() => setAgree(!agree)}>
                        <Ionicons name={agree ? "checkbox" : "square-outline"} size={20} color={agree ? "#eb4b3f" : "#666"} />
                    </TouchableOpacity>
                    <Text style={styles.termsText}>I agree to the <Text style={styles.termsLink}>Terms & Privacy</Text></Text>
                </View>
            {/* End ng Checkbox */}

            {/* Create Account Button */}
                <TouchableOpacity style={styles.createAccountBtn} {...(Platform.OS === 'web' ? { className: 'signup-btn' } : {})}>
                    <Text style={styles.createAccountBtnText}>Create Account</Text>
                </TouchableOpacity>

            {/* Have an Account Hyperlink */}
                <Text style={styles.signinText} {...(Platform.OS === 'web' ? { className: 'signin-text' } : {})}>
                    Have an account? <Text style={styles.signinLink} onPress={() => navigation && navigation.navigate('Login')}>LogIn</Text>
                </Text>
            </View>
        </View>
    );
